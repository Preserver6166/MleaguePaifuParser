...
public class PaipuParser {
    ...
    public static void parse_20_21() throws Exception {
        Scanner scanner = new Scanner(new File("/Users/junjunzhang/Documents/mleague_20-21_v2.txt"));
        PrintWriter pw = new PrintWriter(new File("/Users/junjunzhang/Documents/mleague_20-21_v3.txt"));
    ...
    public static void parse_19_20() throws Exception {
        ...
        Scanner scanner = new Scanner(new File("/Users/junjunzhang/Documents/mleague4.txt"));
        PrintWriter pw = new PrintWriter(new File("/Users/junjunzhang/Documents/mleague5.txt"));
