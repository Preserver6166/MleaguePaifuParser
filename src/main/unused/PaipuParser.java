...
//        System.out.println(StringEscapeUtils.escapeJson("xx:" + JSON.toJSONString(input)));
    ...
    public static void parse_18_19() throws Exception {
        Scanner scanner = new Scanner(new File(PATH + "/Documents/Mleague数据/doc_18-19_v2"));
        PrintWriter pw = new PrintWriter(new File(PATH + "/Documents/Mleague数据/doc_18-19_v3"));
